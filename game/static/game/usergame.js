...
function startCountDown()
{
  ...
  if (number==-1)
  {
    ...
    document.getElementById("guessnumber").value = randomnumber;
    document.getElementById("status").value = "lose";
    document.getElementById("difficulitylevel").value = level;
...
function checkanswers()
{
  ...
  else if(randomnumber==(parseInt(answer)))
  {
      ...
      document.getElementById("guessnumber").value = randomnumber;
      document.getElementById("status").value = "Win";
      document.getElementById("difficulitylevel").value = level;
      document.getElementById("HiddenForm").submit();
